...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*quality-check">Run complete quality gates validation (TypeScript, ESLint, Tests, Mutation)</item>
    <item cmd="*security-audit">Perform security analysis and vulnerability scan</item>
