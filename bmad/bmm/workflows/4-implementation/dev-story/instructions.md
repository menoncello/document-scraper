...
Expected ready-for-dev or in-progress. Continuing anyway...
  ...
  <step n="4" goal="Run quality gates and validations">
    ...
    <critical>NEVER use eslint-disable or @ts-ignore - fix the underlying code issues</critical>
    ...
    <substep n="4.5" goal="Mutation testing validation">
      <action>Run: bun run mutation</action>
      <check>Stryker mutation score must meet 70%+ break threshold</check>
      <action>If score below 70%, improve test coverage before proceeding</action>
    </substep>
    ...
    <action if="any quality gate fails">STOP and fix before continuing - no exceptions</action>
